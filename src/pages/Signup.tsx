...
import { auth, provider, signInWithPopup } from "../data/firebase" 
...
const handleGoogleSignIn = async () => {
  try {
    ...
    // You can redirect or save user info to your backend here
  } catch (error) {
          ...
          <div className="pt-3 flex flex-col justify-between h-full">
            ...
            <div>
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-xs mt-1">Sign up and get 30 days free trial</p>

                <form className="mt-5 w-90" action="">
                  <div className="flex flex-col mb-2">
                    <label className="text-sm ml-4 mb-1">Full Name</label>
                    <input
                      type="text"
                      className="bg-white rounded-full w-full h-10 px-4 focus:outline-none focus:ring-2 focus:ring-gray-600 focus:border-gray-600"
                    />
                  </div>
                ...
                <button onClick={handleGoogleSignIn} className="hover:bg-gray-600 hover:text-white transition ease-out duration-200 cursor-pointer mt-4 text-lg px-9 py-1 border-1 rounded-full mb-5 flex items-center gap-1">
                  <span>
                    <svg
                      className="w-6"
